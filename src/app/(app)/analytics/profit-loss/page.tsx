...
import { ProfitLossClient } from "@/components/analytics/pages/ProfitLossClient";
...
export default async function ProfitLossPage() {
  ...
  return (
    <AppShell title="Profit & Loss" subtitle="Revenue, expenses, accrued money, and net profit/loss — Powered by SCS Nova" isAdmin={canAccessAdminConsole(session.role)}>
      <AnalyticsPageShell>
        <ProfitLossClient data={data} />
      </AnalyticsPageShell>
    </AppShell>
  );
}
